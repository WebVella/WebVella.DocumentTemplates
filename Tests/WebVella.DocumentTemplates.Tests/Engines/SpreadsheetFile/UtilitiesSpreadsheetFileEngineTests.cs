...
public partial class UtilitiesSpreadsheetFileEngineTests : TestBase
{
	private static readonly object locker = new();
	public UtilitiesSpreadsheetFileEngineTests() : base() { }
	...
	public void GetRangeFromString_Test1()
	{
		lock (locker)
		{
			...
			//When
			var result = new WvSpreadsheetRangeHelpers().GetRangeFromString(address);
			//Then
