...
public partial class TemplateContextsSpreadsheetFileEngineTests : TestBase
{
	private static readonly object locker = new();
	public TemplateContextsSpreadsheetFileEngineTests() : base() { }
	...
	public void TemplateContext_Flow_ShouldBeVerticalByDefault()
	{
		lock (locker)
		{
			...
			Assert.Equal(WvSpreadsheetFileTemplateContextType.CellRange, context.Type);
	...
	public void TemplateContext_PictureContext_IsPresent()
	{
		lock (locker)
		{
			...
			//Then
			Assert.NotNull(result);
			var pictureContextList = result.TemplateContexts.Where(x => x.Type == WvSpreadsheetFileTemplateContextType.Picture).ToList();
